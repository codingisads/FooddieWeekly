...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun SignupLastScreen(vm: SignupViewModel, navController: NavHostController, authenticator: Authenticator, loginVm : LoginViewModel) {
    ...
    Column(
        ...
        Box(
            ...
            Button(onClick =
            {
                ...
                //authenticator.signup(vm.email.value, vm.password.value, vm.user, navController, loginVm)

                var db = RealtimeDatabase()

                db.createUserOnDB(authenticator, vm.user)
